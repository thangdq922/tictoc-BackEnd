...
public class VideoController {
	...
	@PostMapping
	public ResponseEntity<?> postVideo(@RequestPart VideoDTO dto, @RequestPart(required = false) MultipartFile upFile) {

		return new ResponseEntity<>(videoService.saveVideo(dto, upFile), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> getListVideo(@RequestParam String type, @RequestParam int page) {
		...
		return new ResponseEntity<>(videoService.findAllVideo(type, pageSlice), HttpStatus.OK);
	}
	...
	@DeleteMapping
	public ResponseEntity<?> deleteVideo(long[] ids) {
		videoService.deleteVideo(ids);
		return ResponseEntity.ok("Delete Success");
	}

	@PatchMapping("/api/view")
	...
	@GetMapping("/{id}/cc")
	public ResponseEntity<?> getsVideo(@PathVariable Long id) {

		return new ResponseEntity<>(videoService.findPopularVideo(id), HttpStatus.OK);
	}
}
